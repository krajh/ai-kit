---
name: brainstorming
description: "Use before creative work (features, components, behavior changes) to explore intent, requirements, and design before implementation."
---
...
- If non-trivial, require a **mini-spec** before coding:
  ...
  ```
- Follow the repo's spec/plan workflow before coding
- Use worktrees or GitButler only if the user requests it
